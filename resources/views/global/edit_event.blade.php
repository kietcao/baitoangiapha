...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('edit_event', ['id' => $event->id])}}" class="row" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="date" class="form-control" id="date" value="{{old('date', $event->date)}}">
                            @error("date")
                                <div><i class="text-danger">{{ $message }}</i></div>
                            @enderror
                        </div>
                            ...
                            <div class="p-2">
                                @php
                                    ...
                                    if (old('join_members') != null) {
                                        ...
                                        $memberChecked = $event->eventsMembers()->get()->toArray();
                                        $joinMembers = $event->eventsMembers()->pluck('event_member.member_id')->implode(',');
                                    }
                                @endphp
                        ...
                        <div class="col-md-12 pt-3 text-center">
                            <button class="btn btn-success btn-lg">Cập nhật sự kiện</button>
                        </div>
                    </form>
                </div>
            </div>
